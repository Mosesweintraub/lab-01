...
```{r Ex_d}
visitors %>% filter(n_2021 == 565,772)
```
...
NA stands for Non-Applicable and we got this answer for the previous question becuase some of the attractions were closed in 2021, likely do to the impacts of the COVID19 pandemic.
...
The mean across all settings are much larger than the median because some attractions are world renound so they attract many times the amount of visitors as other ones did.
